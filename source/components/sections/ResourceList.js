		...
		<div x-data="{
			...
			<div class="c-bookend c-gutter narrow horizontal@xsmall">
				...
				<div class="c-bookend-item c-gutter-item right">
					<a
						class="b-button home has-icon left"
						href="#"
						x-bind:href="searchPath + searchTerm"
					>
						<svg class="b-icon b-button-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
