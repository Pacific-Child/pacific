...
(async () => {
    ...
    const forLoop = async _ => {
            ...
            await fetch(
                url,
                {
                    ...
                    body: JSON.stringify({ query: `
                        query {
                            dataPointValuesForTopic(countryCode: "FJI", topicId: ${topics[index].id}){
                                country
                                dataPoint {
                                    id
                                    body
        ...
        fs.writeFile(`source/data/albatross/countries_FJI.json`, JSON.stringify(restructuredData), (error) => {
